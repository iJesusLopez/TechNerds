...
vc_map(array(
   "name" 			=> esc_html__('Recent Products', 'barberry'),
   "category" 		=> array( 'WooCommerce','Barberry' ),
   "description"	=> "",
   "base" 			=> "recent_products_mixed",
   "class" 			=> "",
   "icon"			=> get_template_directory_uri() . "/images/vc/recent-products.png",
   ...
   "params" 	=> array(
		...
		array(
			...
			"class" 		=> "hide_in_vc_editor",
			"admin_label" 	=> true,
			"heading"		=> esc_html__('Show arrow navigation on hover', 'barberry'),
		...
		array(
			...
			"class" 		=> "hide_in_vc_editor",
			"admin_label" 	=> true,
			"heading"		=> esc_html__('Show Pagination', 'barberry'),
