...
(function($) {
    ...
    if ( in_customizer ) {
		...
		wp.customize.panel( 'woocommerce', function( section ) {
	        go_to_page( section, 'shop_catalog' );
	    } );
	    ...
	    wp.customize.section( 'shop_product', function( section ) {
	        go_to_page( section, 'shop_product' );
	    } );
	}
