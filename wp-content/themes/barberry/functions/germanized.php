...
if( BARBERRY_GERMAN_MARKET_IS_ACTIVE ) {

    /**
     * German market compatibility
     */
 	function barberry_german_market_compatibility() {
   ...
   barberry_german_market_compatibility();
}

if( BARBERRY_WOOCOMMERCE_GERMANIZED_IS_ACTIVE ) {
    /**
     * Germanized compatibility
     */
    function barberry_germanized_compatibility() {
    ...
    barberry_germanized_compatibility();
}