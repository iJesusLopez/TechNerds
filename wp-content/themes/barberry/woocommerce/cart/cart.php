...
<div class="grid-x cart-cells">
	...
	<?php do_action( 'woocommerce_before_cart' ); ?>
		...
		<form id="cart-form" class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="cart-totals cell medium-5 large-4" >
		...
		<div class="cart-collaterals">
				...
				<a class="continue-shopping" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php esc_html_e( 'Continue Shopping', 'barberry' ) ?></a>							
