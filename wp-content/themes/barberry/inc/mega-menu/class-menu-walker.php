 ...
 * @package Barberry
 */
class Barberry_Menu_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_output .= '<a' . $attributes . '><span class="menu-title">' . implode( $badge );
...
// =============================================================================
// Barberry Dropdown Menu Fallback
// =============================================================================

function Barberry_Mega_Menu_Fallback($args)
{    
    echo '<div class="no_menu"></div>';
}

// =============================================================================
// Barberry Drilldown Menu
// =============================================================================

class Barberry_Drilldown_Menu_Walker extends Walker_Nav_Menu
{   
	// private $noIDS = array();
	// private $curItem;  
    ...
    // function start_lvl( &$output, $depth = 0, $args = array() ) {
	   ...
	   //      $indent = str_repeat("\t", $depth);
	   //      $output .= "\n$indent<ul class=\"menu vertical nested site-main-font\">\n";
	   //  }
    // }
