...
<!-- begin grid-x -->
<div class="grid-x vendor-wrapper">

    <!-- begin cart-intro -->
    <div class="cell medium-offset-2 large-offset-3 medium-8 large-6">


        <h2><?php _e( 'Update account to Vendor', 'barberry' ); ?></h2>
            ...
            <div class="dokan-become-seller">
                ...
                <div class="split-row form-row-wide">
                    <p class="form-row form-group">
                        <label for="first-name"><?php _e( 'First Name', 'barberry' ); ?> <span class="required">*</span></label>
                    ...
                    <p class="form-row form-group">
                        <label for="last-name"><?php _e( 'Last Name', 'barberry' ); ?> <span class="required">*</span></label>
                ...
                <p class="form-row form-group form-row-wide">
                    <label for="company-name"><?php _e( 'Shop Name', 'barberry' ); ?> <span class="required">*</span></label>
                ...
                <p class="form-row form-group form-row-wide">
                    <label for="seller-url" class="pull-left"><?php _e( 'Shop URL', 'barberry' ); ?> <span class="required">*</span></label>
                ...
                <p class="form-row form-group form-row-wide">
                    <label for="seller-address"><?php _e( 'Address', 'barberry' ); ?><span class="required">*</span></label>
                ...
                <p class="form-row form-group form-row-wide">
                    <label for="shop-phone"><?php _e( 'Phone Number', 'barberry' ); ?><span class="required">*</span></label>
                ...
                if ( $show_toc == 'on' ) {
                    ...
                    if ( $toc_page_id != -1 ) {
                        ...
                        <p class="form-row form-group form-row-wide">
                            ...
                            <label style="display: inline" for="tc_agree"><?php echo sprintf( __( 'I have read and agree to the <a target="_blank" href="%s">Terms &amp; Conditions</a>.', 'barberry' ), $toc_page_url ); ?></label>
                        </p>
                    <?php } ?>
                <?php } ?>
                ...
                <?php wp_nonce_field( 'account_migration', 'dokan_nonce' ); ?>
                    ...
                    <input type="submit" class="dokan-btn dokan-btn-default" name="dokan_migration" value="<?php _e( 'Become a Vendor', 'barberry' ); ?>" />
                </p>
            </div>
        </form>
